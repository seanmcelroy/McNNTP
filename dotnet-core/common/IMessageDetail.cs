// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IMessageDetail.cs" company="Copyright Sean McElroy">
//   Copyright Sean McElroy
// </copyright>
// <summary>
//   A message detail record provides additional, optionally requested, metadata detail about a message, which may
//   include specific information that is only valid from the perspective of an authorized user making the request.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
