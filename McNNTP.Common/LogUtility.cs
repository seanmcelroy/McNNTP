...
namespace McNNTP.Common
{
    ...
    public static class LogUtility
    {
        ...
        public static void TraceFormat([NotNull] this ILog log, [NotNull][StringSyntax(StringSyntaxAttribute.CompositeFormat)] string format, params object[] args)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown when the format string is null.</exception>
        /// <exception cref="FormatException">Thrown when the format string and associated arguments cannot be used to create a formatted message.</exception>
        public static void VerboseFormat(this ILog log, [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string format, params object[] args)
        {
